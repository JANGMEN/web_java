...
<body>
        ...
        <div style="width:600px; margin:0 auto; padding: 50px; border:1px solid #efefef;">
            ...
            <div class="row">
                <div class="col-sm">
	                ...
	                <div>
                    	<input type="button" value="회원가입" class="btn btn-primary" onclick="sellerJoinAction()"/>
                    </div>
                </div>
            </div>
            </form>
	...
	async function ajaxIDCheck(e){
		console.log(e.value);
		if(e.value.length > 0) {
			const url = '${pageContext.request.contextPath}/api/seller/idcheck.json?id=' + e.value;
